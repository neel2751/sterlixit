...
export function HeroSection() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1a1d18] via-black to-[#2a2e26] text-[#e6e1d7] font-primary overflow-hidden relative w-full">
      ...
      >
        <div style={{ background: colors[200] }}></div>
      </div>

      {/* Floating elements - animated from start */}
      <div
        className="floating-element active"
      ...
      <div className="relative z-10 min-h-screen flex flex-col justify-center items-center px-8 py-12 md:px-16 md:py-20 gap-16 md:gap-24">
        {/* Top tagline */}
        <div className="text-center pt-8 md:pt-12">
          <h2
            className="text-xs md:text-sm font-mono font-light uppercase tracking-[0.2em] opacity-80 leading-relaxed"
          ...
          <div
            className="mt-6 md:mt-8 w-16 h-px opacity-30 mx-auto"
            style={{
        ...
        {/* Main headline */}
        <div className="text-center max-w-6xl mx-auto py-8 md:py-12">
          <h1
            className="text-4xl md:text-6xl lg:text-7xl font-extralight leading-tight tracking-tight text-decoration"
            style={{ color: colors[50] }}
          >
            <div className="mb-8 md:mb-12 pb-6 md:pb-8">
            ...
            <div
              className="text-2xl md:text-4xl lg:text-5xl font-thin leading-relaxed"
              style={{ color: colors[200] }}
            >
        ...
        <div className="text-center pb-8 md:pb-12">
          <div
            className="mb-6 md:mb-8 w-16 h-px opacity-30 mx-auto"
            style={{
              background: `linear-gradient(to right, transparent, ${colors[200]}, transparent)`,
            }}
          ></div>
          ...
          <div
            className="mt-8 md:mt-10 flex justify-center space-x-4 opacity-0"
            style={{
              animation: "word-appear 1s ease-out forwards",
              animationDelay: "4.5s",
            }}
